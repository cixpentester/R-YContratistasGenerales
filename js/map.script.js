...
//  google map 2 function custom ========================== //
	...
	if(jQuery('#gmap_canvas2').length){
		function init_map2() {
			var myOptions = {
				zoom: 10,
				center: new google.maps.LatLng(-6.7571804545919925, -79.83667028203293),
			...
			marker2 = new google.maps.Marker({
				map: map2,
				position: new google.maps.LatLng(-6.7571804545919925, -79.83667028203293),
				optimized: false,
	...
	if(jQuery('#gmap_canvas4').length){
		function init_map4() {
			...
			infowindow4 = new google.maps.InfoWindow({
				content: '<strong>Title</strong><br>Oficina Chiclayo: Jr. Conquista 735 Urb. Latina<br>'
			});
